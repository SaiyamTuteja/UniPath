...
const sendMail = async (to, subject, content) => {
    try {
        await transporter.sendMail({
            from: `"UniPath" <${process.env.EMAIL_USER}>`,
            to,
            subject,
...
export const sendotp = async (to, otp, expiryTime = '10', name = 'User') => {
    ...
    const subject = 'Your OTP for UniPath Verification';
    const html = `
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
            ...
            <tr>
                <td style="text-align: center; ">
                    <img src="https://UniPath.vercel.app/assets/logo-Cuayozfd.png" alt="Grow to Viral" width="150"
                        style="margin-bottom: 10px;">
                    <h1 style="color: #333;">Welcome to UniPath</h1>
            ...
            <tr>
                <td style="padding: 10px; text-align: center; color: #555;">
                    <p>Your OTP for <strong>UniPath Verification</strong> is:</p>
            ...
            <tr>
                <td style="padding: 20px; text-align: center; font-size: 14px; color: #777;">
                    <p>Need help? Reach out to me 
                        <a href="https://www.linkedin.com/in/saiyam-tuteja/" style="color: #1d62c2; text-decoration: none;"
                            target="_blank">linkedin</a>
                        or Github issues.
                    </p>
                    <p>Follow us for updates:</p>
                    <p>
                        <a href="https://github.com/SaiyamTuteja" style="margin: 0 5px; text-decoration: none; color: #1d62c2;"
                            target="_blank">Github</a> |
                        <a href="https://www.linkedin.com/in/SaiyamTuteja/"
