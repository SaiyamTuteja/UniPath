...
const tile = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    attribution: `<p><a href="https://github.com/SaiyamTuteja"><img src="https://flagcdn.com/in.svg" width="15" alt="India"><b> Made by Ayush Saklani</b></a>
    <br>Co-powered by <a href="https://github.com/SaiyamTuteja/classsync"><b>Classsync</b></a></p>`,
}).addTo(map);
//base map from open streetmap added 
// const serverlink = "http://localhost:3001";                         // UniPath local server link
// const serverlink2 = "http://localhost:3000";                        // classsync local server link
// const serverlink = "https://UniPath.onrender.com";                    // UniPath online render server link
// const serverlink2 = "https://classsync-3ht1.onrender.com";          // classsync online render server link
const serverlink =  "https://UniPath.azurewebsites.net";              // UniPath azure server link 
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    await fetchGeoJSON();
    setTimeout(() => {
        document.getElementById('UniPathloader').style.display = "none";
    }, 3000);
    LoaderManager(1);
