                          ...
                          : "from-[#049fbb] to-[#50f6ff]"}`}>
            {
              infotype == "washroom" ?
                <div className="bottom-section">
                  ...
                  <span className="my-2 title">{roomname}</span>
                </div>
                : (type == "office" || type == "other" || type == "staffroom") ?
                  <div className="bottom-section">
                    ...
                    <span className="my-2 title">{roomname} {"|"} {roomid}</span>
                  </div> :
                  <div className="bottom-section">
                    <span className="my-2 title">{roomname} {"|"} {roomid}</span>
                    {
                      (infotype == 'available' || active == false) &&
                      // --- MODIFIED: Added Capacity and Type ---
                      <div className="row text-[#1b233d] grid grid-cols-2">
                        <div className="col-span-1 item">
                          <span className="big-text">{capacity || 'N/A'}</span>
                          <span className="regular-text">Capacity</span>
                        </div>
                        <div className="col-span-1 item">
                          <span className="big-text">{type || 'N/A'}</span>
