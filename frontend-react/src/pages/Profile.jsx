...
import UniPathlogo from './assets/images/logo.png'
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6">
            <div className="flex items-center">
              <div className="bg-white/10 p-2 rounded-full mr-4 backdrop-blur-sm border border-white/10">
                <img
                  ...
                  src={UniPathlogo}
                  alt="UniPath app logo"
                />
              </div>
              <div>
                <h3 className="text-3xl font-bold">UniPath</h3>
            ...
            <p className="text-gray-300 max-w-xl mt-2 md:mt-0 text-sm leading-relaxed">
              UniPath helps students navigate classrooms, manage personalized timetables, and stay organized throughout their academic journey. Designed for simplicity, built for students.
            </p>
          </div>
          ...
          <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/SaiyamTuteja/UniPath"
                target="_blank"
